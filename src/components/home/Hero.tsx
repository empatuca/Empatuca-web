      ...
      <div className="container mx-auto px-4 md:px-12 grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center relative z-10 py-12">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            <Button variant="outline" size="lg" className="border border-white/20 bg-transparent text-white hover:bg-white/5 hover:text-white rounded-xl px-8 h-14 text-base md:text-lg font-bold transition-all uppercase" asChild>
        ...
        >
          <div className="aspect-square bg-[#5a0606] rounded-[2rem] md:rounded-[4rem] transform rotate-3 overflow-hidden shadow-2xl border-4 border-[#fac124]/20 relative">
            <img 
              src="https://images.unsplash.com/photo-1628106278729-327371333338?auto=format&fit=crop&w=800&q=80" 
