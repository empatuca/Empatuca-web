...
export default function Caja() {
  ...
  // Seed August 8, 2026 expenses if not already seeded
  useEffect(() => {
    const seededKey = 'empatuca_seeded_august_8_2026_v3';
    if (!localStorage.getItem(seededKey)) {
      const aug8Gastos = [
        { descripcion: 'Pollo entero', monto: 6.40, categoria: 'Insumos / Producción', created_at: '2026-08-08T09:00:00-05:00' },
        { descripcion: 'Queso 1lb1/2', monto: 4.15, categoria: 'Insumos / Producción', created_at: '2026-08-08T09:15:00-05:00' },
        { descripcion: 'Yerbita', monto: 0.25, categoria: 'Insumos / Producción', created_at: '2026-08-08T09:30:00-05:00' },
        { descripcion: 'Queso mozzarella + mayonesa', monto: 3.40, categoria: 'Insumos / Producción', created_at: '2026-08-08T09:45:00-05:00' },
        { descripcion: 'Coles 3u + mora 3lb + pepinos', monto: 7.50, categoria: 'Insumos / Producción', created_at: '2026-08-08T10:00:00-05:00' },
        { descripcion: 'Leche 3lt', monto: 3.75, categoria: 'Insumos / Producción', created_at: '2026-08-08T10:15:00-05:00' },
        { descripcion: 'Deja', monto: 1.00, categoria: 'Operativo', created_at: '2026-08-08T10:30:00-05:00' },
        { descripcion: 'Agua botellón', monto: 1.25, categoria: 'Operativo', created_at: '2026-08-08T10:45:00-05:00' }
      ];

      const seedAsync = async () => {
        if (isSupabaseConfigured && supabase) {
          try {
            await supabase.from('gastos_diarios').insert(aug8Gastos);
          } catch(e) {
            console.error(e);
          }
        }
        const existingLocal = JSON.parse(localStorage.getItem('empatuca_all_gastos') || '[]');
        const newItems = aug8Gastos.map(g => ({ ...g, id: Math.random().toString() }));
        const updatedAll = [...newItems, ...existingLocal];
        localStorage.setItem('empatuca_all_gastos', JSON.stringify(updatedAll));
        setAllGastos(updatedAll);
        setGastos(prev => [...newItems, ...prev]);
  ...
  // Seed August 9, 10, 11, 2026 expenses
  useEffect(() => {
    const seededKey = 'empatuca_seeded_august_9_11_2026_v1';
    if (!localStorage.getItem(seededKey)) {
      const extraGastos = [
        // 09 agosto 2026
        { descripcion: 'Leche 1lt', monto: 1.00, categoria: 'Insumos / Producción', created_at: '2026-08-09T09:00:00-05:00' },
        { descripcion: 'Aceites caja 12u', monto: 17.80, categoria: 'Insumos / Producción', created_at: '2026-08-09T09:15:00-05:00' },
        { descripcion: 'Queso 2lb1/2', monto: 6.65, categoria: 'Insumos / Producción', created_at: '2026-08-09T09:30:00-05:00' },
        { descripcion: 'Leche 5lt', monto: 3.75, categoria: 'Insumos / Producción', created_at: '2026-08-09T09:45:00-05:00' },
        { descripcion: 'Pasajes', monto: 1.00, categoria: 'Operativo', created_at: '2026-08-09T10:00:00-05:00' },
        { descripcion: 'Huevos cubeta', monto: 3.90, categoria: 'Insumos / Producción', created_at: '2026-08-09T10:15:00-05:00' },
        { descripcion: 'Gas', monto: 2.00, categoria: 'Operativo', created_at: '2026-08-09T10:30:00-05:00' },
        { descripcion: 'Pan', monto: 1.00, categoria: 'Operativo', created_at: '2026-08-09T10:45:00-05:00' },
        { descripcion: 'Agua botellón', monto: 1.00, categoria: 'Insumos / Producción', created_at: '2026-08-09T11:00:00-05:00' },
        { descripcion: 'Leche condensada', monto: 2.40, categoria: 'Insumos / Producción', created_at: '2026-08-09T11:15:00-05:00' },
        { descripcion: 'Desayuno Chris', monto: 1.50, categoria: 'Operativo', created_at: '2026-08-09T11:30:00-05:00' },

        // 10 agosto 2026
        { descripcion: 'Compras proint', monto: 13.74, categoria: 'Insumos / Producción', created_at: '2026-08-10T09:00:00-05:00' },
        { descripcion: 'Compras plasti-fe', monto: 5.49, categoria: 'Operativo', created_at: '2026-08-10T09:15:00-05:00' },
        { descripcion: 'Verde', monto: 10.00, categoria: 'Insumos / Producción', created_at: '2026-08-10T09:30:00-05:00' },
        { descripcion: 'Pasajes', monto: 1.50, categoria: 'Operativo', created_at: '2026-08-10T09:45:00-05:00' },

        // 11 agosto 2026
        { descripcion: 'Col + yerbita', monto: 1.75, categoria: 'Insumos / Producción', created_at: '2026-08-11T09:00:00-05:00' },
        { descripcion: 'Cable + enchufe', monto: 3.50, categoria: 'Operativo', created_at: '2026-08-11T09:15:00-05:00' },
        { descripcion: 'Queso duro 1lb1/2', monto: 4.15, categoria: 'Insumos / Producción', created_at: '2026-08-11T09:30:00-05:00' },
        { descripcion: 'Jamon 3P', monto: 1.50, categoria: 'Insumos / Producción', created_at: '2026-08-11T09:45:00-05:00' },
        { descripcion: 'INTERNET SERVICIO BASICO', monto: 4.00, categoria: 'Servicios Básicos', created_at: '2026-08-11T10:00:00-05:00' },
        { descripcion: 'Chris desayuno', monto: 1.50, categoria: 'Operativo', created_at: '2026-08-11T10:15:00-05:00' }
      ];

      const seedAsync = async () => {
        if (isSupabaseConfigured && supabase) {
          try {
            await supabase.from('gastos_diarios').insert(extraGastos);
          } catch(e) {
            console.error(e);
          }
        }
        const existingLocal = JSON.parse(localStorage.getItem('empatuca_all_gastos') || '[]');
        const newItems = extraGastos.map(g => ({ ...g, id: Math.random().toString() }));
        const updatedAll = [...newItems, ...existingLocal];
        localStorage.setItem('empatuca_all_gastos', JSON.stringify(updatedAll));
        setAllGastos(updatedAll);
        setGastos(prev => [...newItems, ...prev]);
  ...
  // Seed August 12, 13, 14, 2026 expenses
  useEffect(() => {
    const seededKey = 'empatuca_seeded_august_12_14_2026_v1';
    if (!localStorage.getItem(seededKey)) {
      const extraGastos12_14 = [
        // 12 agosto 2026
        { descripcion: 'Verde', monto: 6.50, categoria: 'Insumos / Producción', created_at: '2026-08-12T09:00:00-05:00' },
        { descripcion: 'Pollo entero', monto: 6.50, categoria: 'Insumos / Producción', created_at: '2026-08-12T09:15:00-05:00' },
        { descripcion: 'Queso duro 3lb', monto: 7.50, categoria: 'Insumos / Producción', created_at: '2026-08-12T09:30:00-05:00' },
        { descripcion: 'Compras proint', monto: 22.35, categoria: 'Insumos / Producción', created_at: '2026-08-12T09:45:00-05:00' },
        { descripcion: 'Queso 1/2 lb', monto: 1.35, categoria: 'Insumos / Producción', created_at: '2026-08-12T10:00:00-05:00' },
        { descripcion: 'Canela + pimienta olorosa', monto: 0.50, categoria: 'Insumos / Producción', created_at: '2026-08-12T10:15:00-05:00' },
        { descripcion: 'Sal 1kg', monto: 1.00, categoria: 'Insumos / Producción', created_at: '2026-08-12T10:30:00-05:00' },
        { descripcion: 'Colas Bigcola 24U', monto: 5.75, categoria: 'Insumos / Producción', created_at: '2026-08-12T10:45:00-05:00' },

        // 13 agosto 2026
        { descripcion: 'Medicinas Christopher', monto: 21.00, categoria: 'Operativo', created_at: '2026-08-13T09:00:00-05:00' },
        { descripcion: 'Llaves Hexagonales Chris', monto: 2.50, categoria: 'Operativo', created_at: '2026-08-13T09:15:00-05:00' },
        { descripcion: 'Compras mercado vegetales', monto: 12.00, categoria: 'Insumos / Producción', created_at: '2026-08-13T09:30:00-05:00' },
        { descripcion: 'Taxi', monto: 3.50, categoria: 'Operativo', created_at: '2026-08-13T09:45:00-05:00' },
        { descripcion: 'Bus', monto: 0.50, categoria: 'Operativo', created_at: '2026-08-13T10:00:00-05:00' },
        { descripcion: 'Compras Coral hiper', monto: 4.91, categoria: 'Operativo', created_at: '2026-08-13T10:15:00-05:00' },

        // 14 agosto 2026
        { descripcion: 'Taxi', monto: 1.25, categoria: 'Operativo', created_at: '2026-08-14T09:00:00-05:00' },
        { descripcion: 'Colas', monto: 5.50, categoria: 'Insumos / Producción', created_at: '2026-08-14T09:15:00-05:00' }
      ];

      const seedAsync = async () => {
        if (isSupabaseConfigured && supabase) {
          try {
            await supabase.from('gastos_diarios').insert(extraGastos12_14);
          } catch(e) {
            console.error(e);
          }
        }
        const existingLocal = JSON.parse(localStorage.getItem('empatuca_all_gastos') || '[]');
        const newItems = extraGastos12_14.map(g => ({ ...g, id: Math.random().toString() }));
        const updatedAll = [...newItems, ...existingLocal];
        localStorage.setItem('empatuca_all_gastos', JSON.stringify(updatedAll));
        setAllGastos(updatedAll);
        setGastos(prev => [...newItems, ...prev]);
  ...
  // Seed August 15, 16, 17, 19, 20, 2026 expenses
  useEffect(() => {
    const seededKey = 'empatuca_seeded_august_15_20_2026_v1';
    if (!localStorage.getItem(seededKey)) {
      const extraGastos15_20 = [
        // 15 agosto 2026
        { descripcion: 'Colas junior', monto: 9.00, categoria: 'Insumos / Producción', created_at: '2026-08-15T09:00:00-05:00' },
        { descripcion: 'Cebollas', monto: 0.65, categoria: 'Insumos / Producción', created_at: '2026-08-15T09:15:00-05:00' },
        { descripcion: 'Queso duro 1lb1/2', monto: 4.15, categoria: 'Insumos / Producción', created_at: '2026-08-15T09:30:00-05:00' },
        { descripcion: 'Verde', monto: 20.00, categoria: 'Insumos / Producción', created_at: '2026-08-15T09:45:00-05:00' },
        { descripcion: 'Pollo entero', monto: 7.30, categoria: 'Insumos / Producción', created_at: '2026-08-15T10:00:00-05:00' },
        { descripcion: 'Fundas basura', monto: 1.00, categoria: 'Operativo', created_at: '2026-08-15T10:15:00-05:00' },
        { descripcion: 'Leche 1lt', monto: 1.00, categoria: 'Insumos / Producción', created_at: '2026-08-15T10:30:00-05:00' },

        // 16 agosto 2026
        { descripcion: 'Queso duro 1lb1/2', monto: 4.15, categoria: 'Insumos / Producción', created_at: '2026-08-16T09:00:00-05:00' },
        { descripcion: 'PAGO HNA DEXY', monto: 10.00, categoria: 'Operativo', created_at: '2026-08-16T09:15:00-05:00' },
        { descripcion: 'Evelyn', monto: 10.00, categoria: 'Operativo', created_at: '2026-08-16T09:30:00-05:00' },

        // 17 agosto 2026
        { descripcion: 'Queso duro 1lb1/2', monto: 4.15, categoria: 'Insumos / Producción', created_at: '2026-08-17T09:00:00-05:00' },
        { descripcion: 'Medicinas Christopher', monto: 12.75, categoria: 'Operativo', created_at: '2026-08-17T09:15:00-05:00' },
        { descripcion: 'Compras proint', monto: 26.75, categoria: 'Insumos / Producción', created_at: '2026-08-17T09:30:00-05:00' },
        { descripcion: 'PAGO DE LUZ CNEL', monto: 10.00, categoria: 'Servicios Básicos', created_at: '2026-08-17T09:45:00-05:00' },
        { descripcion: 'Internet Evelyn', monto: 22.50, categoria: 'Servicios Básicos', created_at: '2026-08-17T10:00:00-05:00' },
        { descripcion: 'Maria pago', monto: 15.00, categoria: 'Operativo', created_at: '2026-08-17T10:15:00-05:00' },

        // 19 agosto 2026
        { descripcion: 'Compras proint', monto: 18.00, categoria: 'Insumos / Producción', created_at: '2026-08-19T09:00:00-05:00' },
        { descripcion: 'Compras mercado', monto: 8.00, categoria: 'Insumos / Producción', created_at: '2026-08-19T09:15:00-05:00' },
        { descripcion: 'Taxi + bus', monto: 3.50, categoria: 'Operativo', created_at: '2026-08-19T09:30:00-05:00' },
        { descripcion: 'Pollo entero', monto: 6.50, categoria: 'Insumos / Producción', created_at: '2026-08-19T09:45:00-05:00' },
        { descripcion: 'Leche', monto: 4.50, categoria: 'Insumos / Producción', created_at: '2026-08-19T10:00:00-05:00' },
        { descripcion: 'Verde', monto: 5.00, categoria: 'Insumos / Producción', created_at: '2026-08-19T10:15:00-05:00' },
        { descripcion: 'Queso duro 1lb1/2', monto: 4.15, categoria: 'Insumos / Producción', created_at: '2026-08-19T10:30:00-05:00' },
        { descripcion: 'Evelyn pago', monto: 5.00, categoria: 'Operativo', created_at: '2026-08-19T10:45:00-05:00' },

        // 20 agosto 2026
        { descripcion: 'Verde', monto: 10.00, categoria: 'Insumos / Producción', created_at: '2026-08-20T09:00:00-05:00' },
        { descripcion: 'Queso duro 1lb1/2', monto: 4.15, categoria: 'Insumos / Producción', created_at: '2026-08-20T09:15:00-05:00' },
        { descripcion: 'Queso duro 3lb', monto: 7.50, categoria: 'Insumos / Producción', created_at: '2026-08-20T09:30:00-05:00' },
        { descripcion: 'Papel base cuadros black/red', monto: 7.00, categoria: 'Operativo', created_at: '2026-08-20T09:45:00-05:00' },
        { descripcion: 'Vinil', monto: 2.50, categoria: 'Operativo', created_at: '2026-08-20T10:00:00-05:00' },
        { descripcion: 'Pasajes', monto: 1.00, categoria: 'Operativo', created_at: '2026-08-20T10:15:00-05:00' },
        { descripcion: 'Leche en polvo', monto: 4.00, categoria: 'Insumos / Producción', created_at: '2026-08-20T10:30:00-05:00' }
      ];

      const seedAsync = async () => {
        if (isSupabaseConfigured && supabase) {
          try {
            await supabase.from('gastos_diarios').insert(extraGastos15_20);
          } catch(e) {
            console.error(e);
          }
        }
        const existingLocal = JSON.parse(localStorage.getItem('empatuca_all_gastos') || '[]');
        const newItems = extraGastos15_20.map(g => ({ ...g, id: Math.random().toString() }));
        const updatedAll = [...newItems, ...existingLocal];
        localStorage.setItem('empatuca_all_gastos', JSON.stringify(updatedAll));
        setAllGastos(updatedAll);
        setGastos(prev => [...newItems, ...prev]);
  ...
  // Seed August 21, 22, 23, 24, 2026 expenses
  useEffect(() => {
    const seededKey = 'empatuca_seeded_august_21_24_2026_v1';
    if (!localStorage.getItem(seededKey)) {
      const extraGastos21_24 = [
        // 21 agosto 2026
        { descripcion: 'Zanahoria 1U', monto: 0.25, categoria: 'Insumos / Producción', created_at: '2026-08-21T09:00:00-05:00' },
        { descripcion: 'Limón', monto: 0.50, categoria: 'Insumos / Producción', created_at: '2026-08-21T09:15:00-05:00' },
        { descripcion: 'Christopher', monto: 1.00, categoria: 'Operativo', created_at: '2026-08-21T09:30:00-05:00' },

        // 22 agosto 2026
        { descripcion: 'Carne 1/2lb', monto: 2.00, categoria: 'Insumos / Producción', created_at: '2026-08-22T09:00:00-05:00' },
        { descripcion: 'Pollo entero', monto: 6.40, categoria: 'Insumos / Producción', created_at: '2026-08-22T09:15:00-05:00' },
        { descripcion: 'Verde', monto: 10.00, categoria: 'Insumos / Producción', created_at: '2026-08-22T09:30:00-05:00' },
        { descripcion: 'Col + maicena', monto: 7.00, categoria: 'Insumos / Producción', created_at: '2026-08-22T09:45:00-05:00' },
        { descripcion: 'Evelyn pago', monto: 20.00, categoria: 'Operativo', created_at: '2026-08-22T10:00:00-05:00' },
        { descripcion: 'Maria pago', monto: 5.00, categoria: 'Operativo', created_at: '2026-08-22T10:15:00-05:00' },
        { descripcion: 'Gasolina', monto: 5.00, categoria: 'Operativo', created_at: '2026-08-22T10:30:00-05:00' },
        { descripcion: 'Chris', monto: 1.00, categoria: 'Operativo', created_at: '2026-08-22T10:45:00-05:00' },
        { descripcion: 'Evelyn', monto: 5.00, categoria: 'Operativo', created_at: '2026-08-22T11:00:00-05:00' },

        // 23 agosto 2026
        { descripcion: 'Carne', monto: 30.00, categoria: 'Insumos / Producción', created_at: '2026-08-23T09:00:00-05:00' },
        { descripcion: 'Pan Chris', monto: 0.50, categoria: 'Operativo', created_at: '2026-08-23T09:15:00-05:00' },
        { descripcion: 'Jamon 3p', monto: 1.50, categoria: 'Insumos / Producción', created_at: '2026-08-23T09:30:00-05:00' },
        { descripcion: 'Cebolla blanca + maggi cubo + queso duro 1lb', monto: 3.60, categoria: 'Insumos / Producción', created_at: '2026-08-23T09:45:00-05:00' },
        { descripcion: 'Leche 3lt', monto: 2.25, categoria: 'Insumos / Producción', created_at: '2026-08-23T10:00:00-05:00' },
        { descripcion: 'Col 1u', monto: 1.25, categoria: 'Insumos / Producción', created_at: '2026-08-23T10:15:00-05:00' },

        // 24 agosto 2026
        { descripcion: 'Compras proint', monto: 33.34, categoria: 'Insumos / Producción', created_at: '2026-08-24T09:00:00-05:00' },
        { descripcion: 'Queso duro 10lb', monto: 25.00, categoria: 'Insumos / Producción', created_at: '2026-08-24T09:15:00-05:00' },
        { descripcion: 'Compras mercado vegetales', monto: 25.00, categoria: 'Insumos / Producción', created_at: '2026-08-24T09:30:00-05:00' },
        { descripcion: 'Taxi + bus', monto: 4.00, categoria: 'Operativo', created_at: '2026-08-24T09:45:00-05:00' },
        { descripcion: 'Desayuno Chris', monto: 1.00, categoria: 'Operativo', created_at: '2026-08-24T10:00:00-05:00' },
        { descripcion: 'Cloro + papel higienico', monto: 1.50, categoria: 'Operativo', created_at: '2026-08-24T10:15:00-05:00' },
        { descripcion: 'Fundas papel', monto: 2.75, categoria: 'Operativo', created_at: '2026-08-24T10:30:00-05:00' },
        { descripcion: 'Colas junior', monto: 21.50, categoria: 'Insumos / Producción', created_at: '2026-08-24T10:45:00-05:00' },
        { descripcion: 'Leche 1lt', monto: 0.75, categoria: 'Insumos / Producción', created_at: '2026-08-24T11:00:00-05:00' },
        { descripcion: 'Maria pago', monto: 5.00, categoria: 'Operativo', created_at: '2026-08-24T11:15:00-05:00' },
        { descripcion: 'Evelyn pago', monto: 5.00, categoria: 'Operativo', created_at: '2026-08-24T11:30:00-05:00' }
      ];

      const seedAsync = async () => {
        if (isSupabaseConfigured && supabase) {
          try {
            await supabase.from('gastos_diarios').insert(extraGastos21_24);
          } catch(e) {
            console.error(e);
          }
        }
        const existingLocal = JSON.parse(localStorage.getItem('empatuca_all_gastos') || '[]');
        const newItems = extraGastos21_24.map(g => ({ ...g, id: Math.random().toString() }));
        const updatedAll = [...newItems, ...existingLocal];
        localStorage.setItem('empatuca_all_gastos', JSON.stringify(updatedAll));
        setAllGastos(updatedAll);
        setGastos(prev => [...newItems, ...prev]);
  ...
  // Seed August 26, 27, 28, 29, 30, 2026 expenses
  useEffect(() => {
    const seededKey = 'empatuca_seeded_august_26_30_2026_v1';
    if (!localStorage.getItem(seededKey)) {
      const extraGastos26_30 = [
        // 26 agosto 2026
        { descripcion: 'Lonas + menus', monto: 48.00, categoria: 'Operativo', created_at: '2026-08-26T09:00:00-05:00' },
        { descripcion: 'Pasajes', monto: 1.00, categoria: 'Operativo', created_at: '2026-08-26T09:15:00-05:00' },
        { descripcion: 'Medicinas Chris + shampoo', monto: 11.50, categoria: 'Operativo', created_at: '2026-08-26T09:30:00-05:00' },
        { descripcion: 'Gas tanques 2U', monto: 6.00, categoria: 'Operativo', created_at: '2026-08-26T09:45:00-05:00' },
        { descripcion: 'Curitas', monto: 0.50, categoria: 'Operativo', created_at: '2026-08-26T10:00:00-05:00' },
        { descripcion: 'Maria pago', monto: 5.00, categoria: 'Operativo', created_at: '2026-08-26T10:15:00-05:00' },

        // 27 agosto 2026
        { descripcion: 'Verde', monto: 10.00, categoria: 'Insumos / Producción', created_at: '2026-08-27T09:00:00-05:00' },
        { descripcion: 'Morocho 1p', monto: 2.00, categoria: 'Insumos / Producción', created_at: '2026-08-27T09:15:00-05:00' },
        { descripcion: 'Merienda Chris', monto: 2.00, categoria: 'Operativo', created_at: '2026-08-27T09:30:00-05:00' },
        { descripcion: 'Pollo entero', monto: 6.15, categoria: 'Insumos / Producción', created_at: '2026-08-27T09:45:00-05:00' },
        { descripcion: 'Evelyn', monto: 10.00, categoria: 'Operativo', created_at: '2026-08-27T10:00:00-05:00' },
        { descripcion: 'Maria', monto: 13.00, categoria: 'Operativo', created_at: '2026-08-27T10:15:00-05:00' },

        // 28 agosto 2026
        { descripcion: 'Queso mozzarella', monto: 1.30, categoria: 'Insumos / Producción', created_at: '2026-08-28T09:00:00-05:00' },
        { descripcion: 'Leche 4lt', monto: 3.00, categoria: 'Insumos / Producción', created_at: '2026-08-28T09:15:00-05:00' },
        { descripcion: 'Aji', monto: 1.00, categoria: 'Insumos / Producción', created_at: '2026-08-28T09:30:00-05:00' },
        { descripcion: 'Limón', monto: 0.50, categoria: 'Insumos / Producción', created_at: '2026-08-28T09:45:00-05:00' },
        { descripcion: 'Aceite 1lt', monto: 1.75, categoria: 'Insumos / Producción', created_at: '2026-08-28T10:00:00-05:00' },

        // 29 agosto 2026
        { descripcion: 'Leche 3lt', monto: 2.25, categoria: 'Insumos / Producción', created_at: '2026-08-29T09:00:00-05:00' },
        { descripcion: 'Verde', monto: 9.00, categoria: 'Insumos / Producción', created_at: '2026-08-29T09:15:00-05:00' },
        { descripcion: 'Desayuno Chris', monto: 1.50, categoria: 'Operativo', created_at: '2026-08-29T09:30:00-05:00' },
        { descripcion: 'Pasaje', monto: 1.00, categoria: 'Operativo', created_at: '2026-08-29T09:45:00-05:00' },
        { descripcion: 'Jamon 3p', monto: 1.50, categoria: 'Insumos / Producción', created_at: '2026-08-29T10:00:00-05:00' },
        { descripcion: 'Compras proint', monto: 12.90, categoria: 'Insumos / Producción', created_at: '2026-08-29T10:15:00-05:00' },
        { descripcion: 'Compras mercado', monto: 4.00, categoria: 'Insumos / Producción', created_at: '2026-08-29T10:30:00-05:00' },
        { descripcion: 'Papel higienico + suavitel', monto: 2.00, categoria: 'Operativo', created_at: '2026-08-29T10:45:00-05:00' },
        { descripcion: 'Fundas', monto: 4.00, categoria: 'Operativo', created_at: '2026-08-29T11:00:00-05:00' },
        { descripcion: 'Canela ½ lb', monto: 5.00, categoria: 'Insumos / Producción', created_at: '2026-08-29T11:15:00-05:00' },
        { descripcion: 'Queso mozzarella', monto: 5.00, categoria: 'Insumos / Producción', created_at: '2026-08-29T11:30:00-05:00' },

        // 30 agosto 2026
        { descripcion: 'Pollo entero', monto: 6.40, categoria: 'Insumos / Producción', created_at: '2026-08-30T09:00:00-05:00' },
        { descripcion: 'Leche 3 lt', monto: 2.25, categoria: 'Insumos / Producción', created_at: '2026-08-30T09:15:00-05:00' },
        { descripcion: 'Evelyn pago', monto: 5.00, categoria: 'Operativo', created_at: '2026-08-30T09:30:00-05:00' },
        { descripcion: 'Maria pago', monto: 5.00, categoria: 'Operativo', created_at: '2026-08-30T09:45:00-05:00' },
        { descripcion: 'Candado Chris', monto: 5.65, categoria: 'Operativo', created_at: '2026-08-30T10:00:00-05:00' }
      ];

      const seedAsync = async () => {
        if (isSupabaseConfigured && supabase) {
          try {
            await supabase.from('gastos_diarios').insert(extraGastos26_30);
          } catch(e) {
            console.error(e);
          }
        }
        const existingLocal = JSON.parse(localStorage.getItem('empatuca_all_gastos') || '[]');
        const newItems = extraGastos26_30.map(g => ({ ...g, id: Math.random().toString() }));
        const updatedAll = [...newItems, ...existingLocal];
        localStorage.setItem('empatuca_all_gastos', JSON.stringify(updatedAll));
        setAllGastos(updatedAll);
        setGastos(prev => [...newItems, ...prev]);
  ...
  // Seed August 31, 2026 expenses
  useEffect(() => {
    const seededKey = 'empatuca_seeded_august_31_2026_v1';
    if (!localStorage.getItem(seededKey)) {
      const extraGastos31 = [
        { descripcion: 'Verde', monto: 5.00, categoria: 'Insumos / Producción', created_at: '2026-08-31T09:00:00-05:00' },
        { descripcion: 'Pan', monto: 1.00, categoria: 'Operativo', created_at: '2026-08-31T09:15:00-05:00' },
        { descripcion: 'Colas junior', monto: 7.50, categoria: 'Insumos / Producción', created_at: '2026-08-31T09:30:00-05:00' },
        { descripcion: 'Disco corte Chris', monto: 1.00, categoria: 'Operativo', created_at: '2026-08-31T09:45:00-05:00' },
        { descripcion: 'Aceite 1lt', monto: 2.00, categoria: 'Insumos / Producción', created_at: '2026-08-31T10:00:00-05:00' },
        { descripcion: 'Maria pago', monto: 15.00, categoria: 'Operativo', created_at: '2026-08-31T10:15:00-05:00' },
        { descripcion: 'Evelyn pago', monto: 5.00, categoria: 'Operativo', created_at: '2026-08-31T10:30:00-05:00' }
      ];

      const seedAsync = async () => {
        if (isSupabaseConfigured && supabase) {
          try {
            await supabase.from('gastos_diarios').insert(extraGastos31);
          } catch(e) {
            console.error(e);
          }
        }
        const existingLocal = JSON.parse(localStorage.getItem('empatuca_all_gastos') || '[]');
        const newItems = extraGastos31.map(g => ({ ...g, id: Math.random().toString() }));
        const updatedAll = [...newItems, ...existingLocal];
        localStorage.setItem('empatuca_all_gastos', JSON.stringify(updatedAll));
        setAllGastos(updatedAll);
        setGastos(prev => [...newItems, ...prev]);
